...
public class Timer {
    ...
    /** Delays the program for the amount of milliseconds given, adjusted by the last call to this function. e.g.: If
     * you call this function, do something for 20 milliseconds and then call correctedDelay(30), it will delay for 10
     * milliseconds Allows computers of different speeds to run a program in roughly the same pace; Guarantees programs
     * will take at least delayMillis for the frme to pass **/
