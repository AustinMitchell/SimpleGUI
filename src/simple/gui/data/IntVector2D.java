...
public class IntVector2D implements ConstIntVector2D {
    ...
    /** Checks if the vector inside a box, whose bottom left corner and top right corner are defined by {p1} and {p2}.
     * When called, this method will adjust the x and y components of this vector to keep them within the bounding box.
    ...
    public boolean isBoundWithinPoints(ConstIntVector2D p1, ConstIntVector2D p2) {
        return _x >= p1.x() && _x <= p2.x() && _y >= p1.y() && _y <= p2.y();
    }

    /** Checks if the vector inside a box, whose bottom-left corner and side lengths are defined by {pos} and {dim}.
     * When called, this methodwill adjust the x and y components of this vector to keep them within the bounding box.
    ...
    public boolean isBoundWithinBox(ConstIntVector2D pos, ConstIntVector2D dim) {
        return _x >= pos.x() && _x <= (pos.x() + dim.x()) && _y >= pos.y() && _y <= (pos.y() + dim.y());
    }
    ...
    /** [new vector] Binds the vector inside a box, whose bottom left corner and top right corner are defined by {p1}
     * and {p2}. When called, this method will adjust the x and y components of this vector to keep them within the
     * bounding box.
     * @param  p1 Lower left boundbox corner
     * @param  p2 Upper right boundbox corner
    ...
    /** [new vector] Binds the vector inside a box, whose bottom-left corner and side lengths are defined by {pos} and
     * {dim}. When called, this method will adjust the x and y components of this vector to keep them within the
     * bounding box.
     * @param  pos Bottom left corner of bounding box
     * @param  dim Dimensions of bounding box
     * @return     The same vector instance **/
    ...
    public IntVector2D norm() {
        double m = mag();
        return new IntVector2D((int) Math.round(_x / m), (int) Math.round(_y / m));
    }

    /** [new vector] Normalizes this vector and multiplies it by a scalar (adjust the x and y components so the
     * magnitude is c) **/
    ...
    /** [new vector] Adjusts the x and y components of this vector to match a vector of the given angle with the same
     * magnitude **/
    ...
    /** [new vector] Divides the components of this vector by the components of another vector. WARNING: Does not check
     * for 0 **/
    ...
    public IntVector2D mult(double cx, double cy) {
        return new IntVector2D((int) Math.round(_x * cx), (int) Math.round(_y * cy));
    }
    ...
    /** [in-place] Binds the vector inside a box, whose bottom left corner and top right corner are defined by {p1} and
     * {p2}. When called, this method will adjust the x and y components of this vector to keep them within the bounding
     * box.
     * @param  p1 Lower left boundbox corner
     * @param  p2 Upper right boundbox corner
     * @return    The same vector instance **/
    ...
    /** [in-place] Binds the vector inside a box, whose bottom-left corner and side lengths are defined by {pos} and
     * {dim}. When called, this method will adjust the x and y components of this vector to keep them within the
     * bounding box.
     * @param  pos Bottom left corner of bounding box
     * @param  dim Dimensions of bounding box
    ...
    /** [in-place] Normalizes this vector and multiplies it by a scalar (adjust the x and y components so the magnitude
     * is c) **/
    ...
    /** [in-place] Adjusts the x and y components of this vector to match a vector of the given angle with the same
     * magnitude **/
    ...
    /** [in-place] Divides the components of this vector by the components of another vector. WARNING: Does not check
     * for 0 **/
    ...
    public IntVector2D i_mult(double cx, double cy) {
        return set((int) Math.round(_x * cx), (int) Math.round(_y * cy));
    }

    /** [in-place] Divides each component of this vector by each given scalar respectively **/
    public IntVector2D i_div(double cx, double cy) {
        return set((int) Math.round(_x / cx), (int) Math.round(_y / cy));
    }
    ...
    @Override
    public String toString() { return "Vector: X=" + _x + "; Y=" + _y; }
