...
/** Represents a 2D vector and a bunch of operations on vectors. The difference between this and Vector2D is that all
 * operations that modify the vector components now return a new vector instead of modifying this one. */
