...
public final class Image {
    ...
    @Override
    public int hashCode() {
        return Arrays.hashCode(getPixelsNoCopy());
    }
    @Override
     ...
     */
    public int get(ConstIntVector2D pixel) {
     ...
     */
    public Color getColor(ConstIntVector2D pixel) {
     ...
     * @param color     Color to set pixel to
     */
    public void set(ConstIntVector2D pixel, int color) {
     ...
     * @param color     Color to set pixel to
     */
    public void setColor(ConstIntVector2D pixel, Color color) {
     ...
     */
    void drawCentered(Graphics2D g, int x, int y) {
