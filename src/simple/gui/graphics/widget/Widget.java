...
public abstract class Widget {
    ...
    private IntVector2D _posRelative;
    ...
    public ConstIntVector2D posRelative()   { return _posRelative; }
    ...
    /** Returns if the widget has been considered to have been clicked */
    public boolean          isClicked()     { return _isClicked; }

    /** Returns if the widget has been considered to be 'entered' by the mouse. This is a precondition to the other mouse interaction statuses. */
    public boolean          hasEntered()    { return _hasEntered; }
    ...
    public boolean          containsMouse() {
        return Input.mouse().isBoundWithinBox(_pos, _pos.add(_size));
    }
    ...
    /** Sets widget position to new vector. Should return the widget. */
    public Widget setRelativePosition(ConstIntVector2D pos) { _posRelative = pos.copy();    return this; }
     ...
     * If your widget creates and stores widgets inside it, they need to be registered to the parent.
