...
public class Button extends Widget {
    ...
    public enum State {
        DISABLED, NONE, HOVERING, CLICKING
    }

    private static final Map<State, Color> LIGHT_PALETTE = Map.of(State.DISABLED, new Color(0, 0, 0, 60), State.NONE, new Color(0, 0, 0, 40), State.HOVERING, new Color(0, 0, 0, 20), State.CLICKING,
            new Color(0, 0, 0, 0));

    private static final Map<State, Color> DARK_PALETTE = Map.of(State.DISABLED, new Color(255, 255, 255, 0), State.NONE, new Color(255, 255, 255, 20), State.HOVERING, new Color(255, 255, 255, 40),
    ...
    public Button() { this(new IntVector2D(0, 0), new IntVector2D(10, 10)); }
